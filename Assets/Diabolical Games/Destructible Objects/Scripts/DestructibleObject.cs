    ...
    public class DestructibleObject : MonoBehaviour
    {
        ...
        public void Break(Rigidbody rb)
        {
            ...
            for (int i = 0; i < debris.transform.childCount; i++)
            {
                ...
                Vector3 randomise = new Vector3(Random.Range(0f, velocityMagnitude), Random.Range(0f, velocityMagnitude), Random.Range(0f, velocityMagnitude));
                randomise.Normalize();
                debrisRigidbody.velocity = rigidbody.velocity + (randomise * 2);
            }
            ...
            Destroy(gameObject);
            itemSpwanner.SpawnAndThrowObject();
        }
        public void Break()
        {
        ...
        {
            if (other.gameObject.CompareTag(TagHash.PlayerSword))
            {
                Break(rigidbody);
            }
